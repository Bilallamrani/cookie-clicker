  ...
  document.getElementById("cookie").addEventListener("click", () => {
      ...
      toastr.info("Voulez-vous acheter ce multiplicateur x2 à 50 pts ?", "Confirmation", {
        ...
        onclick: function() {
          ...
          if (score > 50) {
            ...
            bonusx2();
            document.getElementById('clicker-counter').innerHTML = "score :" + score;
            document.getElementById('run1').innerHTML = "50 ptns";
            clickdouble = true;
            clickBonus = false;
            clickboost = false;
            clickAuto = false;
    ...
    onclick: function() {
      ...
      if (score > 50*cptDouble) {
        ...
        toastr.success("Félicitation, vous avez obtenu le bonus x2");
        document.getElementById('clicker-counter').innerHTML = "score :" + score;
        document.getElementById('run1').innerHTML = 50*cptDouble+'ptns ';
        clickdouble = true;
        clickBonus = false;
        clickboost = false;
        clickAuto = false;
    ...
    document.getElementById("run2").addEventListener("click", () => {
        ...
        if(cptBooster==1){
            ...
            onclick: function() {
              if (score > 80) {
                ...
                booster();
                document.getElementById ( 'clicker-counter' ) . innerHTML  = "score :"+score ;
                document.getElementById('run2').innerHTML = "80 ptns";
                clickboost=true;
                clickdouble=false;
                clickBonus=false;
                clickAuto=false;
        ...
        onclick: function() {
          if (score > 80*cptDouble) {
              ...
              toastr.success("Félicitation, vous avez obtenu le bonus x5");
              document.getElementById ( 'clicker-counter' ) . innerHTML  = "score :"+score ;
              document.getElementById('run2').innerHTML = 80*cptDouble+" ptns";
              clickboost=true;
              clickdouble=false;
              clickBonus=false;
              clickAuto=false;
